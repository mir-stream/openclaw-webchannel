...
describe("e2e/local/ports.json", () => {
  ...
  const NOT_PORTS: LiteralBudget[] = [
    ...
    { file: "packages/saas/src/nats-permissions-realserver.test.ts", value: 5000, count: 3, reason: "waitFor and shutdown timeouts in ms" },
    { file: "packages/saas/src/nats-permissions-realserver.test.ts", value: 4000, count: 3, reason: "connection timeout in ms" },
    { file: "packages/saas/src/nats-server-config.ts", value: 65535, count: 2, reason: "port-range validation upper bound" },
    { file: "packages/saas/src/nats-permissions-realserver.test.ts", value: 10000, count: 2, reason: "server readiness timeout in ms" },
    { file: "packages/saas/src/nats-permissions-realserver.test.ts", value: 20000, count: 1, reason: "Vitest hook timeout in ms" },
    { file: "packages/saas/src/nats-permissions-realserver.test.ts", value: 30000, count: 1, reason: "Vitest restart test timeout in ms" },
