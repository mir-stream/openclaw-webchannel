...
echo "      it is ADMIN-GATED — set ENROLLMENT_ADMIN_TOKEN before starting the app):"
echo "        curl -X POST -H 'Authorization: Bearer <ENROLLMENT_ADMIN_TOKEN>' http://127.0.0.1:$PORT/admin/enrollments/<USER_CODE>/approve"
