...
export type HistoryMessage = {
  ...
  text: string;
  ts?: number;
  /** Stable within the originating assistant turn when reconstructable. */
...
export class NullPeerChannel implements WebChannelPeerChannel {
  ...
  sendProgress(_peerId: string, _id: string, _text: string, _turnId?: string, _assistantMessageIndex?: number): boolean { return false; }
