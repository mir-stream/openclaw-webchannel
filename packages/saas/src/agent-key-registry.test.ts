...
import { agentKeyRegistryKey, MemoryAgentKeyRegistry } from "./agent-key-registry.js";
...
describe("MemoryAgentKeyRegistry v2", () => {
  it("runs the exported conformance suite", async () => {
    await runAgentKeyRegistryConformance(() => new MemoryAgentKeyRegistry());
  });
